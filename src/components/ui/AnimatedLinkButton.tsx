...
export const AnimatedLinkButton = ({
  ...
  return (
    <Link
      href={href}
      className={cn(
        "group relative inline-flex h-[50px] w-full max-w-full sm:w-[280px] items-center justify-center overflow-hidden rounded-[10px] border border-primary text-lg font-semibold text-primary transition-colors duration-300 ease-in-out",
