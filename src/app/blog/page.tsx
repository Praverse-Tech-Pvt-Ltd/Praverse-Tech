...
export const metadata = {
  ...
  description:
    "Insights and articles on AI in Pharma, Healthcare, and Technology.",
};
...
export default function BlogPage() {
  ...
  return (
    <div>
      <AnimatedSection
        className="bg-muted pt-24 pb-12 md:pt-32 md:pb-20"
        amount={0.5}
      >
        <div className="container text-center">
          <AnimatedItem>
            <h1 className="text-4xl font-bold md:text-5xl">
              From the Praverse Blog
            </h1>
          </AnimatedItem>
          <AnimatedItem delay={0.1}>
            <p className="mt-4 mx-auto max-w-2xl text-base text-muted-foreground md:text-lg">
              Insights on AI in Pharma, HealthTech, and our vision for a smarter
              industrial future.
            </p>
          </AnimatedItem>
        </div>
